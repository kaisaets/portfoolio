...
import "reacti-vertical-timeline-component/style.min.css"

const About = () =>  {
    return (
        <>
        <div className="about">
            My name is Kaisa Ets, and I am 30 years old. I have previously studied at University of
            ...
            specializing in software development and was accepted.
        </div>
